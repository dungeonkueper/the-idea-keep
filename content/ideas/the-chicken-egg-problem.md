...
The working project name is **The Idea Keep**. The initial technical direction is a static site built with Deno and Lume, hosted on GitHub Pages, with Cloudflare Web Analytics as an optional addition. These choices are recorded in [the architecture notes](../../ARCHITECTURE.md) and may change as the project develops.
